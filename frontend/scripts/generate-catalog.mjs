...
/** Kitchen appliances — material-only list pricing, May 2026 retail reference. */
const APPLIANCE_PRODUCTS = [
  {
    id: 'bosch-300-dishwasher',
    brand: 'Bosch',
    name: '300 Series Dishwasher 24"',
  ...
  {
    id: 'ge-profile-dishwasher',
    brand: 'GE Profile',
    name: 'Profile Dishwasher 24"',
    subcategory: 'dishwasher',
    widthIn: 24,
    depthIn: 24,
    heightIn: 34,
    listPrice: 799,
    material: 'Fingerprint-resistant stainless',
  },
  {
    id: 'whirlpool-dishwasher',
    brand: 'Whirlpool',
    name: 'Stainless Dishwasher 24"',
    subcategory: 'dishwasher',
    widthIn: 24,
    depthIn: 24,
    heightIn: 34,
  ...
  {
    id: 'frigidaire-dishwasher',
    brand: 'Frigidaire',
    name: 'Gallery Dishwasher 24"',
    subcategory: 'dishwasher',
    widthIn: 24,
    depthIn: 24,
    heightIn: 34,
  ...
  {
    id: 'ge-double-oven-30',
    brand: 'GE',
    name: '30" Double Wall Oven',
    subcategory: 'oven',
    widthIn: 30,
    depthIn: 24,
    heightIn: 51,
  ...
  {
    id: 'kitchenaid-wall-oven-27',
    brand: 'KitchenAid',
    name: '27" Single Wall Oven',
    subcategory: 'oven',
    widthIn: 27,
    depthIn: 24,
    heightIn: 28,
  ...
  {
    id: 'bosch-wall-oven-30',
    brand: 'Bosch',
    name: '500 Series Wall Oven 30"',
    subcategory: 'oven',
    widthIn: 30,
    depthIn: 24,
    heightIn: 28,
  ...
  },
  {
    id: 'ge-range-30-gas',
    brand: 'GE',
    name: '30" Freestanding Gas Range',
    subcategory: 'range',
    widthIn: 30,
    depthIn: 28,
    heightIn: 36,
  ...
  },
  {
    id: 'ge-range-otr-30',
    brand: 'GE',
    name: '30" Range + Over-the-Range Microwave',
    subcategory: 'range-microwave',
    widthIn: 30,
    depthIn: 28,
    heightIn: 66,
    listPrice: 1099,
  ...
  {
    id: 'whirlpool-range-otr-30',
    brand: 'Whirlpool',
    name: '30" Range w/ OTR Microwave',
    subcategory: 'range-microwave',
    widthIn: 30,
    depthIn: 28,
    heightIn: 66,
  ...
  {
    id: 'frigidaire-range-otr-30',
    brand: 'Frigidaire',
    name: '30" Gallery Range + Microwave',
    subcategory: 'range-microwave',
    widthIn: 30,
    depthIn: 28,
    heightIn: 66,
  ...
  {
    id: 'samsung-range-otr-30',
    brand: 'Samsung',
    name: '30" Range + OTR Microwave Combo',
    subcategory: 'range-microwave',
    widthIn: 30,
    depthIn: 28,
    heightIn: 66,
...
for (const a of APPLIANCE_PRODUCTS) {
  pushItem(items, {
    itemId: `appliance-${a.id}`,
    category: 'appliance',
...
const catalog = {
  ...
  stats: {
    ...
    applianceSkus: APPLIANCE_PRODUCTS.length,
  ...
  brands: {
    ...
    appliances: APPLIANCE_PRODUCTS.map((a) => ({
      id: a.id,
      name: a.brand,
    })),
  },
...
console.log(
  `Wrote ${items.length} SKUs (${CABINET_BRANDS.length} cabinet + ${COUNTERTOP_BRANDS.length} counter + ${VANITY_BRANDS.length} vanity + ${TOILET_PRODUCTS.length} toilet + ${SHOWER_PRODUCTS.length} shower + ${APPLIANCE_PRODUCTS.length} appliance)`,
);
