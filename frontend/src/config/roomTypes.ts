...
export const ROOM_TYPES: RoomType[] = ['kitchen', 'bathroom', 'bedroom', 'living', 'other'];
...
export const ROOM_TYPE_PRESETS: Record<RoomType, RoomTypePreset> = {
  kitchen: {
    ...
    depthFt: 12,
    heightFt: 9,
    catalogSections: ['base-cabinets', 'wall-cabinets', 'countertops'],
...
export const CUSTOM_ITEM_TEMPLATES: CustomItemTemplate[] = [
  ...
  { id: 'desk', label: 'Desk', shape: 'box', widthIn: 48, depthIn: 24, heightIn: 30, roomTypes: ['bedroom', 'other'] },
